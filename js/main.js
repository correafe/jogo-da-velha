...
function mudarcor (quadrado1, quadrado2, quadrado3){
    quadrado1.style.background = '#556B2F';
    quadrado2.style.background = '#556B2F';
    quadrado3.style.background = '#556B2F';
}
...
function reiniciar () {
    ...
    for (var i = 1; i <= 9; i++) {
        ...
        quadrado.style.background = 'darkgray';
        quadrado.style.color = 'darkgray';
        quadrado.innerHTML = '-';
    }
    mudarjogador('X');
}